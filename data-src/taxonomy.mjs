...
export const WOMEN = {
  ...
  'Kurta Sets': {
    ...
    colours: ['Powder Blue', 'Yellow', 'Rani Pink', 'Mustard', 'Wine', 'Emerald', 'Maroon', 'Indigo', 'Ivory', 'Sage Green', 'Peach', 'Teal'],
    variants: [
...
export const MEN = {
  'Modern Kurta': {
    ...
    colours: ['Black', 'White', 'Ivory', 'Cream', 'Navy', 'Olive', 'Maroon', 'Mustard', 'Beige', 'Mint', 'Wine', 'Indigo', 'Green', 'Purple', 'Brown'],
    variants: [
  ...
  'Ethnic Shirt': {
    ...
    colours: ['White', 'Ivory', 'Navy', 'Cream', 'Sage Green', 'Black', 'Beige', 'Olive', 'Teal', 'Maroon'],
    variants: [
